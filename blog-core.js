...
.section_wir .wir_content-wrapper{display:grid!important;grid-template-columns:1.05fr .95fr!important;gap:50px!important;align-items:center!important;max-width:1120px!important;margin:0 auto!important;padding:36px 0 62px!important}
...
.rh-wir-img{width:100%;height:100%}
.rh-wir-img img{display:block;width:100%;height:100%;min-height:360px;max-height:580px;object-fit:cover;border-radius:22px;box-shadow:0 30px 70px -34px rgba(0,39,124,.5)}
.section_wir .wir_content-wrapper.rh-noleft{grid-template-columns:minmax(0,600px)!important;justify-content:center!important;row-gap:24px!important}
.blog-section{padding-bottom:34px!important}
.rh-form-head{text-align:center;max-width:600px;margin:0 auto;padding:0 14px}
.rh-form-head h2{font-family:var(--rh-display)!important;font-weight:800!important;font-size:clamp(1.7rem,3.2vw,2.4rem)!important;line-height:1.1!important;letter-spacing:-.02em!important;color:var(--rh-ink)!important;margin:0 0 12px!important;text-transform:none!important}
.rh-form-head p{font-family:var(--rh-body)!important;font-size:1.05rem!important;line-height:1.55!important;color:var(--rh-ink-soft)!important;margin:0 auto!important;max-width:40em}
.blog-body-text a.button.w-button.rh-cta-btn,a.w-button.rh-cta-btn{display:inline-flex!important;align-items:center;gap:.5em;background:var(--rh-grad-green)!important;color:#fff!important;font-family:var(--rh-body)!important;font-weight:700!important;font-size:1.04rem!important;line-height:1.1!important;padding:1rem 1.7rem!important;border-radius:13px!important;box-shadow:0 14px 30px -10px rgba(26,170,142,.7)!important;border:0!important;text-transform:none!important;letter-spacing:0!important;transition:transform .18s,filter .2s}
.blog-body-text a.button.w-button.rh-cta-btn:hover,a.w-button.rh-cta-btn:hover{transform:translateY(-2px);filter:saturate(1.08)}
